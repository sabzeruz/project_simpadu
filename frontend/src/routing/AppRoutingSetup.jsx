...
import {  PendataanPegawaiPage, PendataanDosenPage, PendataanPresensiPage } from '@/pages/pendataan';
  ...
  return <Routes>
      <Route element={<RequireAuth />}>
        <Route element={<Demo1Layout />}>
          ...
          <Route path="/pendataan-pegawai" element={<PendataanPegawaiPage />} /> 
          <Route path="/pendataan-dosen" element={<PendataanDosenPage />} /> 
          <Route path="/pendataan-presensi" element={<PendataanPresensiPage />} /> 
