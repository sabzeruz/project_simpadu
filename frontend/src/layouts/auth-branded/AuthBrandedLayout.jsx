      ...
      <div className="grid lg:grid-cols-2 grow">
        ...
        <div className="lg:rounded-xl lg:border lg:border-gray-200 lg:m-5 order-1 lg:order-2 bg-top xxl:bg-center xl:bg-cover bg-no-repeat branded-bg">
          <div className="flex flex-col p-8 lg:p-16 gap-4">
            <Link to="/">
              <img src={toAbsoluteUrl('/media/app/mini-logo.png')} className="h-[28px] max-w-none" alt="" />
            </Link>

            <div className="flex flex-col gap-3">
              <h3 className="text-2xl font-semibold text-gray-900">SIMPADU</h3>
              <div className="text-base font-medium ">
                SIMPADU (Sistem Informasi Terpadu) merupakan 
                platform digital berbasis web dari  &nbsp;
                <span className="text-gray-900 font-semibold">Politeknik Negeri Banjarmasin (Poliban)</span>
