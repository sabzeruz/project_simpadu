  ...
  addComponents({
    '.radio[type="radio"]': {
      ...
      '&:checked, &[aria-checked="true"]': {
        ...
        'background-image': `url("${_minisvgdatauri2.default.call(void 0, '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none"><circle cx="10.9995" cy="11" r="5.86667" fill="white"/></svg>')}")`,
      },
      '&:focus-visible': {
        'outline': 'none',
        'box-shadow': 'none'
    ...
    '.radio-sm[type="radio"]': {
      ...
      '&:checked, &[aria-checked="true"]': {
        'background-image': `url("${_minisvgdatauri2.default.call(void 0, '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9.0002" cy="8.99995" r="4.8" fill="white"/></svg>')}")`,
      },
    },
    '.radio-lg[type="radio"]': {
      ...
      '&:checked, &[aria-checked="true"]': {
        'background-image': `url("${_minisvgdatauri2.default.call(void 0, '<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none"><circle cx="12.9997" cy="13" r="6.93333" fill="white"/></svg>')}")`,
      },
    },
  });
