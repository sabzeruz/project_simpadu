...
exports. default = _plugin2.default.call(void 0, ({ addComponents, theme }) => {
  addComponents({
    '.select': {
      ...
      'background-image': `url("${_minisvgdatauri2.default.call(void 0, `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path fill="none" stroke="${theme('base.colors.gray.light.600')}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m2 5 6 6 6-6"/></svg>`)}")`,
      '.dark &': {
        'background-image': `url("${_minisvgdatauri2.default.call(void 0, `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path fill="none" stroke="${theme('base.colors.gray.dark.600')}" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m2 5 6 6 6-6"/></svg>`)}")`,
      },
